/**
 * ARCHIVED: getUnifiedPanelHtml() — Legacy 3-column transaction logger UI
 *
 * This function was the original webview HTML for the UnifiedPanel and MonitorViewProvider.
 * It has been superseded by getChatPanelHtml() in ../unifiedPanelHtml.ts (2026-04-04).
 *
 * KEPT FOR:
 * - Reference implementation of the three-column layout pattern
 * - Potential fallback during transition period
 * - Feature port reference (if specific UX from old UI is needed)
 * - Institutional knowledge preservation
 *
 * See README.md in this folder for restoration instructions and safe deletion checklist.
 *
 * ─────────────────────────────────────────────────────────────────────────────────
 * FULL SOURCE CODE OF LEGACY FUNCTION (lines 1-1577 of original unifiedPanelHtml.ts)
 * ─────────────────────────────────────────────────────────────────────────────────
 */
