...
|---|---|---|---|
| [s01-purpose.md](core/s01-purpose.md) | §1 Purpose & Philosophy | The core guarantee; two-layer model (pipeline vs. skill) | ✓ impl |
...
| [s03-file-format.md](core/s03-file-format.md) | §3 File Format | 4-step discovery order (§3.1); top-level YAML schema | ✓ impl |
| [s04-execution-model.md](core/s04-execution-model.md) | §4 Execution Model | invocation step (§4.1); core guarantee (§4.2); §4.4 run log + NDJSON events | ✓ impl |
| [s05-step-specification.md](core/s05-step-specification.md) | §5 Step Specification | All step fields; on_result; then:/before:; tools: (§5.6) | ✓ impl (tools:) |
...
| [s11-template-variables.md](core/s11-template-variables.md) | §11 Template Variables | `{{ }}` syntax; all variable paths and resolution rules | ✓ impl |
...
| [s17-materialize-chain.md](core/s17-materialize-chain.md) | §17 materialize-chain | CLI command; output format with origin comments | ✓ impl |
...
| [s20-mvp.md](core/s20-mvp.md) | §20 MVP v0.0.1 Scope | What is and isn't in scope for v0.0.1 | ✓ impl |
...
| [r02-claude-cli.md](runner/r02-claude-cli.md) | Reference Implementation — Claude CLI | Verified flags, event stream, session continuity, tool permission interface | ✓ impl |
