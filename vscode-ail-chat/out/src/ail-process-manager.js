...
exports.AilProcessManager = void 0;
exports.mapAilEventToMessages = mapAilEventToMessages;
const child_process_1 = require("child_process");
const ndjson_1 = require("./ndjson");
class AilProcessManager {
    ...
    start(prompt, pipeline, options = {}) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const proc = (0, child_process_1.spawn)(this._binaryPath, args, { cwd: this._cwd, env });
            this._activeProcess = proc;
            (0, ndjson_1.parseNdjsonStream)(proc.stdout, (event) => {
...
exports.AilProcessManager = AilProcessManager;
/**
...
//# sourceMappingURL=ail-process-manager.js.map