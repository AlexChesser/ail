...
pub fn run(
    ...
    // Request keyboard enhancement (Kitty protocol) so terminals that support it send
    // distinguishable Shift+Enter, Ctrl+Enter, etc. Falls back gracefully on unsupported terminals.
